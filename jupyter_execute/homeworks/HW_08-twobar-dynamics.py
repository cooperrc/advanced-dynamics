...
# # HW - 08
# 
# Create the equations of motion and solve the differential algebraic equations (DAE) for a two-bar system under the force of gravity. You can modify the solution for the one-bar system given in **A**.
# 
